...
function GridBackground() {
  ...
  useEffect(() => {
    ...
    const colors = ["#e6007e", "#c9a84c", "#3b82f6"];
    for (let i = 0; i < 45; i++) {
...
const metricColors = ["#e6007e", "#c9a84c", "#3b82f6", "#8b5cf6"];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} className="flex flex-wrap gap-3">
              <a href="#turkerler" className="group px-6 py-3 bg-gradient-to-r from-primary to-accent text-white text-sm font-medium rounded-lg transition-all hover:shadow-[0_0_20px_rgba(230,0,126,0.2)]">
